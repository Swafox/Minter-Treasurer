...
function RecreateCoinTxData(_ref) {
  ...
  this.txData = new minterjsTx.TxDataRecreateCoin({
...
RecreateCoinTxData.fromRlp = function fromRlp(data) {
  return RecreateCoinTxData.fromBufferFields(new minterjsTx.TxDataRecreateCoin(data));
};

module.exports = RecreateCoinTxData;
