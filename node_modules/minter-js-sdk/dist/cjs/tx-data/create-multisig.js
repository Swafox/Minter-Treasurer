...
function CreateMultisigTxData(_ref) {
  ...
  this.txData = new minterjsTx.TxDataCreateMultisig({
...
CreateMultisigTxData.fromRlp = function fromRlp(data) {
  return CreateMultisigTxData.fromBufferFields(new minterjsTx.TxDataCreateMultisig(data));
};

module.exports = CreateMultisigTxData;
